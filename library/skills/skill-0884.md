# Refactoring Playbook 0884

## Metadata
- id: skill-0884
- category: refactoring
- difficulty: intermediate
- tags: refactoring, intermediate, reliability, playbook

## Instruction
Restructure code safely with behavior-preserving changes and measurable outcomes. Use deterministic steps, ask only necessary clarifying questions, and return a concise execution plan plus final deliverables.
