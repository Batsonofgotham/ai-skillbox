# Security Playbook 0137

## Metadata
- id: skill-0137
- category: security
- difficulty: intermediate
- tags: security, intermediate, reliability, playbook

## Instruction
Inspect for vulnerabilities, prioritize exploitability, and recommend hardening steps. Use deterministic steps, ask only necessary clarifying questions, and return a concise execution plan plus final deliverables.
