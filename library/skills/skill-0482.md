# Coding Playbook 0482

## Metadata
- id: skill-0482
- category: coding
- difficulty: intermediate
- tags: coding, intermediate, reliability, playbook

## Instruction
Implement clean production-ready code with explicit assumptions and edge-case handling. Use deterministic steps, ask only necessary clarifying questions, and return a concise execution plan plus final deliverables.
